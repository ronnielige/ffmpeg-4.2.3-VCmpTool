...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-shared --enable-ffplay
prefix=/usr/local
...
CC_IDENT=gcc 8.2.1 (Rev1, Built by MSYS2 project) 20181214
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=   -std=c11 -fomit-frame-pointer -I/mingw64/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -I/mingw64/include/SDL2
...
CFLAGS-ffplay=-Dmain=SDL_main -I/mingw64/include/SDL2
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lgdi32 -lm -lvfw32 -L/mingw64/lib -lmingw32 -lSDL2main -lSDL2 -lmingw32 -lSDL2main -lSDL2 -Wl,--no-undefined -lm -ldinput8 -ldxguid -ldxerr8 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lshell32 -lsetupapi -lversion -luuid -static-libgcc
EXTRALIBS-avfilter=-lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -L/mingw64/lib -lz -lsecur32 -lws2_32
EXTRALIBS-avcodec=-liconv -lm -llzma -L/mingw64/lib -lz -lole32 -luser32
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-lm -luser32 -lbcrypt
EXTRALIBS-ffplay=-L/mingw64/lib -lmingw32 -lSDL2main -lSDL2 -lmingw32 -lSDL2main -lSDL2 -Wl,--no-undefined -lm -ldinput8 -ldxguid -ldxerr8 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lshell32 -lsetupapi -lversion -luuid -static-libgcc -lshell32
EXTRALIBS-ffprobe=-lshell32
EXTRALIBS-ffmpeg=-lole32 -lpsapi -lshell32
EXTRALIBS-cpu_init=
EXTRALIBS-cws2fws=-L/mingw64/lib -lz
!ARCH_AARCH64=yes
!ARCH_ALPHA=yes
!ARCH_ARM=yes
!ARCH_AVR32=yes
